    ...
    children: [
      ...
      new Paragraph({
        children: [new ImageRun({
          type: "png",
          data: fs.readFileSync("temp/architecture.png"),
          transformation: { width: 500, height: 375 },
          altText: { title: "系统架构图", description: "系统三层架构图", name: "架构图" }
        })]
      }),
      ...
      new Paragraph({
        children: [new ImageRun({
          type: "png",
          data: fs.readFileSync("temp/module.png"),
          transformation: { width: 500, height: 375 },
          altText: { title: "功能模块图", description: "系统功能模块结构图", name: "模块图" }
        })]
      }),
      ...
      new Paragraph({
        children: [new ImageRun({
          type: "png",
          data: fs.readFileSync("temp/er.png"),
          transformation: { width: 600, height: 450 },
          altText: { title: "数据库ER图", description: "数据库实体关系图", name: "ER图" }
        })]
      }),
      ...
      new Paragraph({
        children: [new ImageRun({
          type: "png",
          data: fs.readFileSync("temp/user-entity.png"),
          transformation: { width: 500, height: 375 },
          altText: { title: "用户实体图", description: "用户和网站实体类图", name: "实体图" }
        })]
      }),
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("5.1.2 分类导航")]
      }),
      new Paragraph({
      ...
      new Paragraph({
        heading: HeadingLevel.HEADING_3,
        children: [new TextRun("5.1.3 网站详情页")]
      }),
      new Paragraph({
      ...
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("丁雪丰. Spring Boot实战[M]. 北京: 人民邮电出版社, 2016.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("霍春阳. Vue.js设计与实现[M]. 北京: 电子工业出版社, 2022.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("刘增辉. MyBatis从入门到精通[M]. 北京: 电子工业出版社, 2017.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("梁灏. Vue.js实战[M]. 北京: 清华大学出版社, 2017.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("张开涛. 亿级流量网站架构核心技术[M]. 北京: 电子工业出版社, 2017.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("林信良. Spring Boot技术内幕[M]. 北京: 机械工业出版社, 2020.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun("李刚. 疯狂Java讲义[M]. 北京: 电子工业出版社, 2019.")]
      }),
      new Paragraph({
        numbering: { reference: "numbers", level: 0 },
        children: [new TextRun(" Craig Walls. Spring Boot实战[M]. 丁雪丰, 译. 北京: 人民邮电出版社, 2016.")]
      }),
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("../专业实训V（JavaEE项目）设计报告书_完整版.docx", buffer);
  console.log("V3版本报告生成成功！");
}).catch(err => {
